namespace WebBanHang.Data.Migrations
{
    ...
    public partial class deleteTableRoleDb : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.Employees", "RoleName", c => c.String(maxLength: 128));
            ...
            CreateIndex("dbo.Employees", "RoleName");
            AddForeignKey("dbo.Employees", "RoleName", "dbo.Roles", "RoleName");
        }
    }
}
